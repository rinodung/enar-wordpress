			...
			<div id="bbp-user-subscriptions" class="bbp-user-subscriptions">
				...
				<div class="bbp-user-section">
					...
					<?php else : ?>
						...
						<p><?php bbp_is_user_home() ? esc_html_e( 'You are not currently subscribed to any forums.', 'bbpress' ) : esc_html_e( 'This user is not currently subscribed to any forums.', 'bbpress' ); ?></p>
				...
				<div class="bbp-user-section">
					...
					<?php else : ?>
						...
						<p><?php bbp_is_user_home() ? esc_html_e( 'You are not currently subscribed to any topics.', 'bbpress' ) : esc_html_e( 'This user is not currently subscribed to any topics.', 'bbpress' ); ?></p>
