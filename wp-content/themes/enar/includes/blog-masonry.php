<?php
	...
	$masonry_cols_nums   = ( is_home() && $sidebar_position_final == 'none' ) ? 'three_blocks colored_masonry' : 'two_blocks colored_masonry';	
	$masonry_type        = 'colored';
	$blog_template       = false;
	$portfolio_template  = false;
	$get_pots_from_post  = 'post';
	
		  if ( $templatename == 'template-blog-masonry-2-columns-colored.php' ) { 
					$masonry_cols_nums = 'two_blocks colored_masonry';
					$blog_template     = true;
				
	}else if ( $templatename == 'template-blog-masonry-3-columns-colored.php' ) { 
					$masonry_cols_nums = 'three_blocks colored_masonry';
					$blog_template     = true;
		
	}else if ( $templatename == 'template-blog-masonry-4-columns-colored.php' ) { 
					$masonry_cols_nums = 'four_blocks colored_masonry';
					$blog_template     = true;
		
	}else if ( $templatename == 'template-blog-masonry-2-columns-simple.php' ) {  
					$masonry_cols_nums = 'two_blocks';
					$masonry_type      = 'simple';
					$blog_template     = true;
		
	}else if ( $templatename == 'template-blog-masonry-3-columns-simple.php' ) {  
					$masonry_cols_nums = 'three_blocks';
					$masonry_type      = 'simple';
					$blog_template     = true;
		
	}else if ( $templatename == 'template-blog-masonry-4-columns-simple.php' ) {  
					$masonry_cols_nums = 'four_blocks';
					$masonry_type      = 'simple';
					$blog_template     = true;
		
	}else if ( $templatename == 'template-portfolio-masonry-2-columns-colored.php' ) {  //============>
					$masonry_cols_nums  = 'two_blocks colored_masonry';
					$portfolio_template = true;
					$get_pots_from_post = 'portfolio';
				
	}else if ( $templatename == 'template-portfolio-masonry-3-columns-colored.php' ) { 
					$masonry_cols_nums  = 'three_blocks colored_masonry';
					$portfolio_template = true;
					$get_pots_from_post = 'portfolio';
				
	}else if ( $templatename == 'template-portfolio-masonry-4-columns-colored.php' ) { 
					$masonry_cols_nums  = 'four_blocks colored_masonry';
					$portfolio_template = true;
					$get_pots_from_post = 'portfolio';
				
	}else if ( $templatename == 'template-portfolio-masonry-2-columns-simple.php' ) { 
					$masonry_cols_nums  = 'two_blocks';
					$masonry_type       = 'simple';
					$portfolio_template = true;
					$get_pots_from_post = 'portfolio';
				
	}else if ( $templatename == 'template-portfolio-masonry-3-columns-simple.php' ) { 
					$masonry_cols_nums  = 'three_blocks';
					$masonry_type       = 'simple';
					$portfolio_template = true;
					$get_pots_from_post = 'portfolio';
				
	}else if ( $templatename == 'template-portfolio-masonry-4-columns-simple.php' ) { 
					$masonry_cols_nums  = 'four_blocks';
					$masonry_type       = 'simple';
					$portfolio_template = true;
					$get_pots_from_post = 'portfolio';
	...
	$home_num_posts        = intval(idealtheme_option('home_posts_per_page_masonry'));
...
?>
	<div class="clearfix">
		<div class="<?php echo esc_attr($float_to); ?>">
        	<div class="hm_filter_wrapper masonry_posts <?php echo esc_attr($masonry_cols_nums); ?>">  
                ...
                <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); 
                    ...
                    $masonry_bg_color     = get_post_meta($post->ID, 'idealtheme_post_masonry_bg_color', true);
                    $theme_default_color  = idealtheme_option('site_main_color');
					$masonry_bg_color_set = '';
					
					if ( $masonry_type == 'colored' ){
						 $masonry_bg_color_set = ( !empty($masonry_bg_color) ) ? "background-color:{$masonry_bg_color}" : "background-color:{$theme_default_color}";
					}
                    
                    $masonry_bg_color_style = $masonry_bg_color_set;
                ...
                <div class="blog_grid_block">
                    ...
                    <div class="blog_grid_desc" <?php echo 'style="'.esc_attr($masonry_bg_color_style).'"'; ?>>
                    ...
                    <div class="blog_grid_con">
                        <?php if ( get_post_type() == 'post' && idealtheme_option('post_meta_show_format') == true ) {  ?>
                            <?php if ( $format == 'audio' && $audio_type == "self_hosted" ) { } else { ?>
                                <a href="<?php echo esc_url($format_link); ?>" class="blog_grid_format">
                                    <i class="<?php echo esc_attr(idealtheme_get_format_icon($post->ID)); ?>" <?php echo 'style="'.esc_attr($masonry_bg_color_style).'"'; ?>></i>
                                </a>
							<?php } ?>
                        ...
                        <?php 
							$num_words = intval(idealtheme_option('home_masonry_expert_length'));
            ...
            <div class="centered masonry_more">
                <a href="#" class="btn_c" data-loaded_num="<?php echo esc_attr($num_posts_loaded); ?>" data-offset="<?php echo esc_attr($posts_per_page); ?>" data-all-posts="<?php echo esc_attr($published_posts); ?>" data-post-type="<?php echo esc_attr($get_pots_from_post); ?>" data-masonry-column="<?php echo esc_attr($masonry_cols_nums); ?>" data-masonry-type="<?php echo esc_attr($masonry_type); ?>">
