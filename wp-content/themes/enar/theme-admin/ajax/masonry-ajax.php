...
add_action( 'init', 'idealtheme_fun_ajax_masonry' );
function idealtheme_fun_ajax_masonry() {
	
	wp_enqueue_script( 'idealtheme_ajax_masonry', get_template_directory_uri().'/theme-admin/ajax/masonry-ajax.js', 'jquery', '1.0', true);
    $no_more_text =  ( idealtheme_option('no_more_posts_text') !== '' ) ? idealtheme_option('no_more_posts_text') : esc_html__( 'No More Posts', 'enar');   
	wp_localize_script( 'idealtheme_ajax_masonry', 'ajax_masonry', array(
		'url' => admin_url( 'admin-ajax.php' ),
		'nonce' => wp_create_nonce( 'ajax-nonce' ),
		'empty' => $no_more_text,
	));
          
	add_action( 'wp_ajax_ajax_masonry', 'idealtheme_ajax_masonry_show_more' );  
	add_action( 'wp_ajax_nopriv_ajax_masonry', 'idealtheme_ajax_masonry_show_more');
}

function idealtheme_ajax_masonry_show_more() {
	...
	$masonry_column = $_POST['masonry_column'];
	$masonry_type = $_POST['masonry_type'];
	...
	<?php 
        ...
        $masonry_cols_nums = $masonry_column;	
