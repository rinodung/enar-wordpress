...
class RWMB_Select_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_style( 'rwmb-idealtheme_css', RWMB_CSS_URL . 'idealtheme.css', array(), RWMB_VER );
		wp_enqueue_script( 'rwmb-idealtheme_js', RWMB_JS_URL . 'idealtheme.js', array( 'jquery' ), RWMB_VER, true );
		wp_enqueue_script( 'rwmb-idealtheme_migrate', RWMB_JS_URL . 'jquery-migrate-1.2.1.min.js', array( 'jquery', 'underscore' ), RWMB_VER, true );
	}
	...
	static function html( $meta, $field )
	{
		...
		$html = sprintf(
			'<div class="hm_select_con"><span class="hm_select_arrow"><i class="ico-keyboard-arrow-down"></i></span><select %s>',
