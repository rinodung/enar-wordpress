<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'    => 'basic',
        'desc'  => esc_html__( 'Basic fields as subsections.', 'redux-framework-demo' ),
        'icon'  => 'el el-home'
    ) );
    ...
    Redux::setSection( $opt_name, array(
        'title'      => esc_html__( 'Text Area', 'redux-framework-demo' ),
        ...
        'fields'     => array(
            array(
                'id'       => 'textarea-example',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Text Area Field', 'redux-framework-demo' ),
                'subtitle' => esc_html__( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => esc_html__( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
