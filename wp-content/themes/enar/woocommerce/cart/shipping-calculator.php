...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h6><?php esc_html_e( 'Calculate Shipping', 'woocommerce' ); ?></h6>

	<div class="check_out_shipping_form">

		<p class="check_out_shipping_row form-row form-row-wide" id="calc_shipping_country_field">
		...
		<p class="check_out_shipping_row form-row form-row-wide" id="calc_shipping_state_field">
			<?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', false ) ) : ?>
			...
			<p class="check_out_shipping_row form-row form-row-wide" id="calc_shipping_city_field">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="check_out_shipping_row form-row form-row-wide" id="calc_shipping_postcode_field">
		...
		<p class="check_out_shipping_row"><button type="submit" name="calc_shipping" value="1" class="button"><?php esc_html_e( 'Update Totals', 'woocommerce' ); ?></button></p>
