...
if ( $customer_orders ) : ?>
	...
	<h4 class="lato_font hm_woo_space"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', esc_html__( 'Recent Orders', 'woocommerce' ) ); ?></h4>
	...
	<table class="shop_table shop_table_responsive my_account_orders">
		...
		<tbody><?php
			foreach ( $customer_orders as $customer_order ) {
				...
				?><tr class="order">
					<td class="order-number" data-title="<?php esc_html_e( 'Order Number', 'woocommerce' ); ?>">
